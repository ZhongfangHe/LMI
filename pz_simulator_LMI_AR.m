...
function [pz, ind2, logrw, count, pz_mean, pz_cov] = pz_simulator_LMI_AR(y, x, vary,...
    u, rho, a, v2, pz_old, ind2_old, b0_mean, b0_cov, pstar, AMH_c, ...
