...
% tau follows GIB(0.5,0.5,1,a) with the hyperparameters tau_d, i.e. sqrt(tau) follows C^+(0,sqrt(a))
% tauj follow IB(0.5,0.5) with the hyperparameters tauj_d
...
function [tau, tau_d, tauj, tauj_d, phi, phi_d, rhoh] = KHS_update3_scale(diff_beta, diff_beta2,...
            tau, tau_d, tauj, tauj_d, phi, phi_d, rhoh, prior_rhoh, a)
...
% tau_d = 1/exprnd(1+1/tau); %unscaled
tau_d = 1/exprnd(1/a+1/tau); %scaled 
